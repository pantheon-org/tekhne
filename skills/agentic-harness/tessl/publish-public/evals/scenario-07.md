...
2. Agent runs `tessl review run skills/development/typescript-advanced --optimize`
3. Agent waits for optimization to complete
4. Agent runs `tessl review run skills/development/typescript-advanced` again to check improvements
