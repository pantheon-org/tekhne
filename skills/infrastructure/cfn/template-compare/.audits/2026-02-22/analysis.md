...
skill_location: skills/cfn-template-compare/SKILL.md
---
...
| D3: Anti-Pattern Quality | 9 | 15 | Specificity and enforceability |
...
- skills/cfn-template-compare/SKILL.md:1
- **Evidence**: Score is 99/120 (grade B).
- **Impact**: Lower score reduces reliability and clarity for execution.

### 2. Maintainability pressure

- skills/cfn-template-compare/SKILL.md:1
- **Evidence**: File size is 458 lines; references count is 2.
...
- skills/cfn-template-compare/SKILL.md for generic tutorial language vs project-specific guidance.
...
**Re-check**: sh skills/skill-quality-auditor/scripts/evaluate.sh cfn-template-compare --json
...
**Assessment**: 9/15 (signal: moderate, priority: medium)
...
skills/skill-quality-auditor/scripts/validate-review-format.sh .context/audits/cfn-template-compare-audit-2026-02-22.md
```
