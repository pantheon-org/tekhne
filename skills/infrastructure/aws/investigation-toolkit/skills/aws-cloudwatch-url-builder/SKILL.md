...
Raw: `/aws/lambda/example-app-pr-ExampleLambdaFunction786A3E0-2j0cL2524eAR`

Encoded (`/` → `*2f`):
```
*2faws*2flambda*2fexample-app-pr-ExampleLambdaFunction786A3E0-2j0cL2524eAR
```
...
|-----------|-------------|---------|
| `region` | AWS region code | `eu-west-1` |
| `alarm_name` | Full CloudWatch alarm name | `example-app-pr-ExampleLambdaFunctionErrorAlarmC578E080-LyOUE2A6wiS2` |
...
`ErrorCount-ExampleLambdaFunction`) rather than the native `AWS/Lambda Errors` metric.
