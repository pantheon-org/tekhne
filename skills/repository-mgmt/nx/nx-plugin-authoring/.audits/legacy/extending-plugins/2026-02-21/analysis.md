...
skill_location: skills/extending-nx-plugins/SKILL.md
---
...
| D5: Progressive Disclosure | 5 | 15 | SKILL-to-references balance |
| D6: Freedom Calibration | 12 | 15 | Constraint/flexibility balance |
...
- skills/extending-nx-plugins/SKILL.md:1
...
- skills/extending-nx-plugins/SKILL.md:1
- **Evidence**: File size is 553 lines; references count is 0.
...
- skills/extending-nx-plugins/SKILL.md for generic tutorial language vs project-specific guidance.
...
**Re-check**: sh skills/skill-quality-auditor/scripts/evaluate.sh extending-nx-plugins --json
...
**Assessment**: 5/15 (signal: weak, priority: high)
...
skills/skill-quality-auditor/scripts/validate-review-format.sh .context/audits/extending-nx-plugins-audit-2026-02-21.md
```
