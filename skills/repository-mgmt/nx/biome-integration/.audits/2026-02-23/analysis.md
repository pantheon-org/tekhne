...
skill_location: skills/nx-biome-integration/SKILL.md
---
...
- skills/nx-biome-integration/SKILL.md:1
- **Evidence**: Score is 106/120 (grade B+).
- **Impact**: Lower score reduces reliability and clarity for execution.

### 2. Maintainability pressure

- skills/nx-biome-integration/SKILL.md:1
- **Evidence**: File size is 140 lines; references count is 3.
...
- skills/nx-biome-integration/SKILL.md for generic tutorial language vs project-specific guidance.
...
**Re-check**: sh skills/skill-quality-auditor/scripts/evaluate.sh nx-biome-integration --json
...
skills/skill-quality-auditor/scripts/validate-review-format.sh .context/audits/nx-biome-integration-audit-2026-02-23.md
```
