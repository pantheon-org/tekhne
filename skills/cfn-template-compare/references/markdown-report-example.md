...
- **examplemonitoringstthorocExampleAccessSecurityGroupfrom1...** (`AWS::EC2::SecurityGroupIngress`)
- **examplemonitoringstthorocExampleAccessSecurityGroupfrom2...** (`AWS::EC2::SecurityGroupIngress`)
- **examplemonitoringstthorocTicketBaseAnalyticsDailyRuleAllowEventRule...** (`AWS::Lambda::Permission`)
- **examplemonitoringstthorocMonitoringMetadataDBFreeStorageSpace15Alarm** (`AWS::CloudWatch::Alarm`)
- **examplemonitoringstthorocMonitoringMetadataDBFreeStorageSpace25Alarm** (`AWS::CloudWatch::Alarm`)
- **examplemonitoringstthorocMonitoringMetadataDBFreeStorageSpace30Alarm** (`AWS::CloudWatch::Alarm`)
- **examplemonitoringstthorocTaskSummaryAnalyticsDailyRuleAllowEventRule...** (`AWS::Lambda::Permission`)
