...
| --- | ---: | ---: | --- |
| D1: Knowledge Delta | 14 | 20 | Depth of non-obvious guidance |
...
**Assessment**: 14/20 (signal: moderate, priority: medium)
...
skills/skill-quality-auditor/scripts/validate-review-format.sh .context/audits/colyseus-multiplayer-audit-2026-02-22.md
```
