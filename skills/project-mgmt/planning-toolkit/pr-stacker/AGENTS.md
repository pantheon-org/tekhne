# PR Stacker — Agent Navigation

## Usage Instructions

1. Read `SKILL.md` first — it is the navigation hub.
2. Identify your task from the categories below.
3. Load **only** the references listed for that task.
4. Do NOT pre-load all references — load on demand.
