...
- `mapped-types.md` in the sibling `typescript-type-system` skill — the mapped-type mechanics these recursive utilities build on
- `readonly-record.md` in the sibling `typescript-utility-types` skill — the shallow, built-in `Readonly<T>` this pattern generalises
- `illegal-states.md` in the sibling `typescript-practices` skill — the general principle immutable config types apply
