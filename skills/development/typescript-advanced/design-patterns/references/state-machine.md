...
- `illegal-states.md` in the sibling `typescript-practices` skill — the general principle state machines apply
- `discriminated-unions.md` in the sibling `typescript-type-guards` skill — the union-narrowing mechanics state transitions rely on
- `basic-guards.md` and `generic-guards.md` in the sibling `typescript-type-guards` skill — writing state-check predicates
