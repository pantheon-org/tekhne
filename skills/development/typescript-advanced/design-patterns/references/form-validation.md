...
- `runtime-validation.md` in the sibling `typescript-practices` skill — Zod schema validation this pattern composes with
- `basic-guards.md` and `generic-guards.md` in the sibling `typescript-type-guards` skill — the type predicates behind field-level validators
- `state-machine.md` in this skill — modelling multi-step form/wizard flows as a discriminated union
