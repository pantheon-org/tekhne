...
- `state-machine.md` in this skill — another pattern that enforces valid transitions at compile time
- `illegal-states.md` in the sibling `typescript-practices` skill — the general principle this pattern applies
- `mapped-types.md` in the sibling `typescript-type-system` skill — the mapped-type mechanics builder types rely on
