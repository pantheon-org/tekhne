...
- `builder.md` in this skill — a complementary pattern for constructing typed configuration objects
- `state-machine.md` in this skill — modelling the states an emitter's consumers transition through
- `basic-guards.md` and `generic-guards.md` in the sibling `typescript-type-guards` skill — narrowing emitted payloads by event type
