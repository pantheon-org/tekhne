...
- `builder.md` in this skill — building typed request/response configs incrementally
- `basic-guards.md` and `generic-guards.md` in the sibling `typescript-type-guards` skill — writing the type predicates used to validate responses
- `runtime-validation.md` in the sibling `typescript-practices` skill — Zod-based validation for responses
