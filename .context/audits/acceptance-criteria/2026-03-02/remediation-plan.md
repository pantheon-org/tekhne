...
source_audit: ".context/audits/acceptance-criteria/2026-03-02/audit.json"
---
...
sh skills/skill-quality-auditor/scripts/evaluate.sh acceptance-criteria --json | jq '.total >= 108'
```
