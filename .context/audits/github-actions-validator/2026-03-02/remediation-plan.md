# Remediation Plan: github-actions-validator

---
plan_date: "2026-03-02"
skill_name: "github-actions-validator"
source_audit: ".context/audits/github-actions-validator/2026-03-02/audit.json"
---
...
**File**: `skills/github-actions-validator/SKILL.md`
...
```bash
# Re-run evaluation
sh skills/skill-quality-auditor/scripts/evaluate.sh github-actions-validator --json --store

# Check target score achieved
sh skills/skill-quality-auditor/scripts/evaluate.sh github-actions-validator --json | jq '.total >= 102'
```
...
```bash
git checkout HEAD~1 -- skills/github-actions-validator/SKILL.md
```
