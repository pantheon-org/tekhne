# Remediation Plan: terraform-validator

---
plan_date: "2026-03-02"
skill_name: "terraform-validator"
source_audit: ".context/audits/terraform-validator/2026-03-02/audit.json"
---
...
**File**: `skills/terraform-validator/SKILL.md`
...
```bash
# Re-run evaluation
sh skills/skill-quality-auditor/scripts/evaluate.sh terraform-validator --json --store

# Check target score achieved
sh skills/skill-quality-auditor/scripts/evaluate.sh terraform-validator --json | jq '.total >= 102'
```
...
```bash
git checkout HEAD~1 -- skills/terraform-validator/SKILL.md
```
