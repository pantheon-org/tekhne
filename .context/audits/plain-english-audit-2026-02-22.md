...
skill_location: skills/plain-english/SKILL.md
---
...
| D8: Practical Usability | 8 | 15 | Actionable examples/commands |

## Critical Issues

### 1. Score-to-grade risk

- skills/plain-english/SKILL.md:1
- **Evidence**: Score is 85/120 (grade C).
- **Impact**: Lower score reduces reliability and clarity for execution.

### 2. Maintainability pressure

- skills/plain-english/SKILL.md:1
- **Evidence**: File size is 205 lines; references count is 0.
...
- skills/plain-english/SKILL.md for generic tutorial language vs project-specific guidance.
...
**Re-check**: sh skills/skill-quality-auditor/scripts/evaluate.sh plain-english --json
...
skills/skill-quality-auditor/scripts/validate-review-format.sh .context/audits/plain-english-audit-2026-02-22.md
```
