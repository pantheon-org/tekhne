...
- skills/agents-md/SKILL.md:1
- **Evidence**: File size is 234 lines; references count is 7.
...
skills/skill-quality-auditor/scripts/validate-review-format.sh .context/audits/agents-md-audit-2026-02-22.md
```
