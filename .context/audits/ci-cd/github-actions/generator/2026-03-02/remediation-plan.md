# Remediation Plan: github-actions-generator

---
plan_date: "2026-03-02"
skill_name: "github-actions-generator"
source_audit: ".context/audits/github-actions-generator/2026-03-02/audit.json"
---
...
**File**: `skills/github-actions-generator/SKILL.md`
...
```bash
# Re-run evaluation
sh skills/skill-quality-auditor/scripts/evaluate.sh github-actions-generator --json --store

# Check target score achieved
sh skills/skill-quality-auditor/scripts/evaluate.sh github-actions-generator --json | jq '.total >= 102'
```
...
```bash
git checkout HEAD~1 -- skills/github-actions-generator/SKILL.md
```
