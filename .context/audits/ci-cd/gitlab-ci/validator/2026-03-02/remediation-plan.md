# Remediation Plan: gitlab-ci-validator

---
plan_date: "2026-03-02"
skill_name: "gitlab-ci-validator"
source_audit: ".context/audits/gitlab-ci-validator/2026-03-02/audit.json"
---
...
**File**: `skills/gitlab-ci-validator/SKILL.md`
...
```bash
# Re-run evaluation
sh skills/skill-quality-auditor/scripts/evaluate.sh gitlab-ci-validator --json --store

# Check target score achieved
sh skills/skill-quality-auditor/scripts/evaluate.sh gitlab-ci-validator --json | jq '.total >= 102'
```
...
```bash
git checkout HEAD~1 -- skills/gitlab-ci-validator/SKILL.md
```
