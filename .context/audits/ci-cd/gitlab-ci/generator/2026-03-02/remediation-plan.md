# Remediation Plan: gitlab-ci-generator

---
plan_date: "2026-03-02"
skill_name: "gitlab-ci-generator"
source_audit: ".context/audits/gitlab-ci-generator/2026-03-02/audit.json"
---
...
**File**: `skills/gitlab-ci-generator/SKILL.md`
...
```bash
# Re-run evaluation
sh skills/skill-quality-auditor/scripts/evaluate.sh gitlab-ci-generator --json --store

# Check target score achieved
sh skills/skill-quality-auditor/scripts/evaluate.sh gitlab-ci-generator --json | jq '.total >= 108'
```
...
```bash
git checkout HEAD~1 -- skills/gitlab-ci-generator/SKILL.md
```
