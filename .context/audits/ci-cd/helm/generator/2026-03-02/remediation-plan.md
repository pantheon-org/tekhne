# Remediation Plan: helm-generator

---
plan_date: "2026-03-02"
skill_name: "helm-generator"
source_audit: ".context/audits/helm-generator/2026-03-02/audit.json"
---
...
**File**: `skills/helm-generator/SKILL.md`
...
```bash
# Re-run evaluation
sh skills/skill-quality-auditor/scripts/evaluate.sh helm-generator --json --store

# Check target score achieved
sh skills/skill-quality-auditor/scripts/evaluate.sh helm-generator --json | jq '.total >= 108'
```
...
```bash
git checkout HEAD~1 -- skills/helm-generator/SKILL.md
```
