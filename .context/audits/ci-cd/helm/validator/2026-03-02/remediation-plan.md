# Remediation Plan: helm-validator

---
plan_date: "2026-03-02"
skill_name: "helm-validator"
source_audit: ".context/audits/helm-validator/2026-03-02/audit.json"
---
...
**File**: `skills/helm-validator/SKILL.md`
...
```bash
# Re-run evaluation
sh skills/skill-quality-auditor/scripts/evaluate.sh helm-validator --json --store

# Check target score achieved
sh skills/skill-quality-auditor/scripts/evaluate.sh helm-validator --json | jq '.total >= 102'
```
...
```bash
git checkout HEAD~1 -- skills/helm-validator/SKILL.md
```
