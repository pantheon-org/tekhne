# Remediation Plan: software-engineering/challenge

---
plan_date: "2026-04-11"
skill_name: "software-engineering/challenge"
source_audit: ".context/audits/software-engineering/challenge/2026-04-11/audit.json"
---
...
**File**: `skills/software-engineering/challenge/SKILL.md`
...
```bash
# Re-run evaluation
./scripts/evaluate.sh software-engineering/challenge --json --store

# Check target score achieved
./scripts/evaluate.sh software-engineering/challenge --json | jq ".total >= 119"
```
...
```bash
git checkout HEAD~1 -- skills/software-engineering/challenge/SKILL.md
```
