# Remediation Plan: software-engineering/design-patterns

---
plan_date: "2026-03-04"
skill_name: "software-engineering/design-patterns"
source_audit: ".context/audits/software-engineering/design-patterns/2026-03-04/audit.json"
---
...
**File**: `skills/software-engineering/design-patterns/SKILL.md`
...
```bash
# Re-run evaluation
sh skills/agentic-harness/skill-quality-auditor/scripts/evaluate.sh software-engineering/design-patterns --json --store

# Check target score achieved
sh skills/agentic-harness/skill-quality-auditor/scripts/evaluate.sh software-engineering/design-patterns --json | jq ".total >= 119"
```
...
```bash
git checkout HEAD~1 -- skills/software-engineering/design-patterns/SKILL.md
```
