# Remediation Plan: software-engineering/testable-design

---
plan_date: "2026-03-04"
skill_name: "software-engineering/testable-design"
source_audit: ".context/audits/software-engineering/testable-design/2026-03-04/audit.json"
---
...
**File**: `skills/software-engineering/testable-design/SKILL.md`
...
```bash
# Re-run evaluation
sh skills/agentic-harness/skill-quality-auditor/scripts/evaluate.sh software-engineering/testable-design --json --store

# Check target score achieved
sh skills/agentic-harness/skill-quality-auditor/scripts/evaluate.sh software-engineering/testable-design --json | jq ".total >= 119"
```
...
```bash
git checkout HEAD~1 -- skills/software-engineering/testable-design/SKILL.md
```
