...
skill_name: "software-engineering/troubleshoot"
source_audit: ".context/audits/software-engineering/troubleshoot/2026-04-11/audit.json"
---
...
**File**: `skills/software-engineering/troubleshoot/SKILL.md`
...
```bash
# Re-run evaluation
./scripts/evaluate.sh software-engineering/troubleshoot --json --store

# Check target score achieved
./scripts/evaluate.sh software-engineering/troubleshoot --json | jq ".total >= 112"
```
...
```bash
git checkout HEAD~1 -- skills/software-engineering/troubleshoot/SKILL.md
```
