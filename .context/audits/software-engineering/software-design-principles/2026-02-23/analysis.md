...
- skills/software-design-principles/SKILL.md:1
- **Evidence**: File size is 132 lines; references count is 44.
...
skills/skill-quality-auditor/scripts/validate-review-format.sh .context/audits/software-design-principles-audit-2026-02-23.md
```
