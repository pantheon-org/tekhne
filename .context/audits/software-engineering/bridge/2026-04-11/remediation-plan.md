# Remediation Plan: software-engineering/bridge

---
plan_date: "2026-04-11"
skill_name: "software-engineering/bridge"
source_audit: ".context/audits/software-engineering/bridge/2026-04-11/audit.json"
---
...
**File**: `skills/software-engineering/bridge/SKILL.md`
...
```bash
# Re-run evaluation
./scripts/evaluate.sh software-engineering/bridge --json --store

# Check target score achieved
./scripts/evaluate.sh software-engineering/bridge --json | jq ".total >= 112"
```
...
```bash
git checkout HEAD~1 -- skills/software-engineering/bridge/SKILL.md
```
