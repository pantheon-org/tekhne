...
- skills/typescript-advanced/SKILL.md:1
- **Evidence**: File size is 87 lines; references count is 48.
...
skills/skill-quality-auditor/scripts/validate-review-format.sh .context/audits/typescript-advanced-audit-2026-02-21.md
```
