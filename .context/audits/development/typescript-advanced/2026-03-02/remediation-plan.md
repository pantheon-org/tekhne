...
source_audit: ".context/audits/typescript-advanced/2026-03-02/audit.json"
---
...
```bash
# Re-run evaluation
sh skills/skill-quality-auditor/scripts/evaluate.sh typescript-advanced --json --store

# Check target score achieved
sh skills/skill-quality-auditor/scripts/evaluate.sh typescript-advanced --json | jq '.total >= 108'
```
