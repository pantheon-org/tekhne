...
- skills/bun-development/SKILL.md:1
- **Evidence**: File size is 61 lines; references count is 13.
...
skills/skill-quality-auditor/scripts/validate-review-format.sh .context/audits/bun-development-audit-2026-02-22.md
```
