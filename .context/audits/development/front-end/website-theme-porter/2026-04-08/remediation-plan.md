...
skill_name: "development/front-end/website-theme-porter"
source_audit: ".context/audits/development/front-end/website-theme-porter/2026-04-08/audit.json"
---
...
```bash
# Re-run evaluation
./scripts/evaluate.sh development/front-end/website-theme-porter --json --store

# Check target score achieved
./scripts/evaluate.sh development/front-end/website-theme-porter --json | jq ".total >= 126"
```
...
```bash
git checkout HEAD~1 -- skills/development/front-end/website-theme-porter/SKILL.md
```
