...
skill_name: "development/front-end/web-reference-sheet-generator"
source_audit: ".context/audits/development/front-end/web-reference-sheet-generator/2026-04-08/audit.json"
---
...
|-------|-----------|----------|--------|
| Missing or incomplete evals | D9 (9/20) | High | Skill not validated at runtime |
...
**Target**: Increase D9 from 9/20 to 17/20 (+8 points)
...
```bash
# Re-run evaluation
./scripts/evaluate.sh development/front-end/web-reference-sheet-generator --json --store

# Check target score achieved
./scripts/evaluate.sh development/front-end/web-reference-sheet-generator --json | jq ".total >= 126"
```
...
```bash
git checkout HEAD~1 -- skills/development/front-end/web-reference-sheet-generator/SKILL.md
```
