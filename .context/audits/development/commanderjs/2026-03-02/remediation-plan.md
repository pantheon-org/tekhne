...
source_audit: ".context/audits/commanderjs/2026-03-02/audit.json"
---
...
```bash
# Re-run evaluation
sh skills/skill-quality-auditor/scripts/evaluate.sh commanderjs --json --store

# Check target score achieved
sh skills/skill-quality-auditor/scripts/evaluate.sh commanderjs --json | jq '.total >= 102'
```
