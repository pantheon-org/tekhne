# Remediation Plan: makefile-generator

---
plan_date: "2026-03-02"
skill_name: "makefile-generator"
source_audit: ".context/audits/makefile-generator/2026-03-02/audit.json"
---
...
**File**: `skills/makefile-generator/SKILL.md`
...
```bash
# Re-run evaluation
sh skills/skill-quality-auditor/scripts/evaluate.sh makefile-generator --json --store

# Check target score achieved
sh skills/skill-quality-auditor/scripts/evaluate.sh makefile-generator --json | jq '.total >= 108'
```
...
```bash
git checkout HEAD~1 -- skills/makefile-generator/SKILL.md
```
