...
skill_location: skills/colyseus-multiplayer/SKILL.md
---
...
| --- | ---: | ---: | --- |
| D1: Knowledge Delta | 15 | 20 | Depth of non-obvious guidance |
...
- skills/colyseus-multiplayer/SKILL.md:1
- **Evidence**: Score is 104/120 (grade B+).
- **Impact**: Lower score reduces reliability and clarity for execution.

### 2. Maintainability pressure

- skills/colyseus-multiplayer/SKILL.md:1
- **Evidence**: File size is 121 lines; references count is 3.
...
**Assessment**: 15/20 (signal: moderate, priority: medium)

**Inspect**:

- skills/colyseus-multiplayer/SKILL.md for generic tutorial language vs project-specific guidance.
...
**Re-check**: sh skills/skill-quality-auditor/scripts/evaluate.sh colyseus-multiplayer --json
...
skills/skill-quality-auditor/scripts/validate-review-format.sh .context/audits/colyseus-multiplayer-audit-2026-02-23.md
```
