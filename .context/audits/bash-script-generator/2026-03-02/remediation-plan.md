# Remediation Plan: bash-script-generator

---
plan_date: "2026-03-02"
skill_name: "bash-script-generator"
source_audit: ".context/audits/bash-script-generator/2026-03-02/audit.json"
---
...
**File**: `skills/bash-script-generator/SKILL.md`
...
```bash
# Re-run evaluation
sh skills/skill-quality-auditor/scripts/evaluate.sh bash-script-generator --json --store

# Check target score achieved
sh skills/skill-quality-auditor/scripts/evaluate.sh bash-script-generator --json | jq '.total >= 108'
```
...
```bash
git checkout HEAD~1 -- skills/bash-script-generator/SKILL.md
```
