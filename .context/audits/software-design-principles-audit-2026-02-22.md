...
skill_location: skills/software-design-principles/SKILL.md
---
...
| --- | ---: | ---: | --- |
| D1: Knowledge Delta | 18 | 20 | Depth of non-obvious guidance |
| D2: Mindset + Procedures | 10 | 15 | Procedural clarity and sequencing |
| D3: Anti-Pattern Quality | 10 | 15 | Specificity and enforceability |
| D4: Specification Compliance | 15 | 15 | Metadata/spec alignment |
| D5: Progressive Disclosure | 10 | 15 | SKILL-to-references balance |
| D6: Freedom Calibration | 12 | 15 | Constraint/flexibility balance |
| D7: Pattern Recognition | 10 | 10 | Trigger/intent discoverability |
| D8: Practical Usability | 12 | 15 | Actionable examples/commands |

## Critical Issues

### 1. Score-to-grade risk

- skills/software-design-principles/SKILL.md:1
- **Evidence**: Score is 97/120 (grade B).
- **Impact**: Lower score reduces reliability and clarity for execution.

### 2. Maintainability pressure

- skills/software-design-principles/SKILL.md:1
- **Evidence**: File size is 382 lines; references count is 44.
...
**Assessment**: 18/20 (signal: strong, priority: low)

**Inspect**:

- skills/software-design-principles/SKILL.md for generic tutorial language vs project-specific guidance.
...
**Re-check**: sh skills/skill-quality-auditor/scripts/evaluate.sh software-design-principles --json
...
skills/skill-quality-auditor/scripts/validate-review-format.sh .context/audits/software-design-principles-audit-2026-02-22.md
```
