# Remediation Plan: k8s-yaml-generator

---
plan_date: "2026-03-02"
skill_name: "k8s-yaml-generator"
source_audit: ".context/audits/k8s-yaml-generator/2026-03-02/audit.json"
---
...
**File**: `skills/k8s-yaml-generator/SKILL.md`
...
```bash
# Re-run evaluation
sh skills/skill-quality-auditor/scripts/evaluate.sh k8s-yaml-generator --json --store

# Check target score achieved
sh skills/skill-quality-auditor/scripts/evaluate.sh k8s-yaml-generator --json | jq '.total >= 102'
```
...
```bash
git checkout HEAD~1 -- skills/k8s-yaml-generator/SKILL.md
```
