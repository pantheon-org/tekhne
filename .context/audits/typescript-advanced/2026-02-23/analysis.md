...
skill_location: skills/typescript-advanced/SKILL.md
---
...
- skills/typescript-advanced/SKILL.md:1
...
- skills/typescript-advanced/SKILL.md:1
- **Evidence**: File size is 181 lines; references count is 48.
...
- skills/typescript-advanced/SKILL.md for generic tutorial language vs project-specific guidance.
...
**Re-check**: sh skills/skill-quality-auditor/scripts/evaluate.sh typescript-advanced --json
...
skills/skill-quality-auditor/scripts/validate-review-format.sh .context/audits/typescript-advanced-audit-2026-02-23.md
```
