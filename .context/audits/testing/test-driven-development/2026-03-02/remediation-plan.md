...
source_audit: ".context/audits/test-driven-development/2026-03-02/audit.json"
---
...
```bash
# Re-run evaluation
sh skills/skill-quality-auditor/scripts/evaluate.sh test-driven-development --json --store

# Check target score achieved
sh skills/skill-quality-auditor/scripts/evaluate.sh test-driven-development --json | jq '.total >= 108'
```
