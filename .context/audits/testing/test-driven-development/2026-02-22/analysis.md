...
- skills/test-driven-development/SKILL.md:1
- **Evidence**: File size is 336 lines; references count is 42.
...
skills/skill-quality-auditor/scripts/validate-review-format.sh .context/audits/test-driven-development-audit-2026-02-22.md
```
