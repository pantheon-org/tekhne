...
- skills/bdd-testing/SKILL.md:1
- **Evidence**: File size is 64 lines; references count is 7.
...
skills/skill-quality-auditor/scripts/validate-review-format.sh .context/audits/bdd-testing-audit-2026-02-21.md
```
