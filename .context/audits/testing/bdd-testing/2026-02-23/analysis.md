...
skill_location: skills/bdd-testing/SKILL.md
---
...
- skills/bdd-testing/SKILL.md:1
- **Evidence**: File size is 134 lines; references count is 7.
...
- skills/bdd-testing/SKILL.md for generic tutorial language vs project-specific guidance.
...
**Re-check**: sh skills/skill-quality-auditor/scripts/evaluate.sh bdd-testing --json
...
skills/skill-quality-auditor/scripts/validate-review-format.sh .context/audits/bdd-testing-audit-2026-02-23.md
```
