...
skill_location: skills/implementation-plan-splitter/SKILL.md
---
...
- skills/implementation-plan-splitter/SKILL.md:1
...
- skills/implementation-plan-splitter/SKILL.md:1
- **Evidence**: File size is 338 lines; references count is 2.
...
- skills/implementation-plan-splitter/SKILL.md for generic tutorial language vs project-specific guidance.
...
**Re-check**: sh skills/skill-quality-auditor/scripts/evaluate.sh implementation-plan-splitter --json
...
skills/skill-quality-auditor/scripts/validate-review-format.sh .context/audits/implementation-plan-splitter-audit-2026-02-22.md
```
