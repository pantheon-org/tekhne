# Remediation Plan: azure-pipelines-generator

---
plan_date: "2026-03-02"
skill_name: "azure-pipelines-generator"
source_audit: ".context/audits/azure-pipelines-generator/2026-03-02/audit.json"
---
...
**File**: `skills/azure-pipelines-generator/SKILL.md`
...
```bash
# Re-run evaluation
sh skills/skill-quality-auditor/scripts/evaluate.sh azure-pipelines-generator --json --store

# Check target score achieved
sh skills/skill-quality-auditor/scripts/evaluate.sh azure-pipelines-generator --json | jq '.total >= 108'
```
...
```bash
git checkout HEAD~1 -- skills/azure-pipelines-generator/SKILL.md
```
