...
skill_name: "documentation/research/scientific-schematics"
source_audit: ".context/audits/documentation/research/scientific-schematics/2026-04-10/audit.json"
---
...
**Verdict**: Targeted improvements needed to reach grade B (+23 points).
...
| Poor progressive disclosure | D5 (5/15) | High | Skill is too long or lacks refs |
...
**File**: `skills/documentation/research/scientific-schematics/SKILL.md`
...
**Target**: Increase D5 from 5/15 to 13/15 (+8 points)
...
```bash
# Re-run evaluation
./scripts/evaluate.sh documentation/research/scientific-schematics --json --store

# Check target score achieved
./scripts/evaluate.sh documentation/research/scientific-schematics --json | jq ".total >= 112"
```
...
```bash
git checkout HEAD~1 -- skills/documentation/research/scientific-schematics/SKILL.md
```
