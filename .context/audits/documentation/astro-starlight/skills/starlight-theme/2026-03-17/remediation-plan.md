...
skill_name: "documentation/astro-starlight/skills/starlight-theme"
source_audit: ".context/audits/documentation/astro-starlight/skills/starlight-theme/2026-03-17/audit.json"
---
...
```bash
# Re-run evaluation
sh skills/agentic-harness/skill-quality-auditor/scripts/evaluate.sh documentation/astro-starlight/skills/starlight-theme --json --store

# Check target score achieved
sh skills/agentic-harness/skill-quality-auditor/scripts/evaluate.sh documentation/astro-starlight/skills/starlight-theme --json | jq ".total >= 126"
```
...
```bash
git checkout HEAD~1 -- skills/documentation/astro-starlight/skills/starlight-theme/SKILL.md
```
