# Remediation Plan: documentation/astro-starlight/skills/starlight-base

---
plan_date: "2026-03-17"
skill_name: "documentation/astro-starlight/skills/starlight-base"
source_audit: ".context/audits/documentation/astro-starlight/skills/starlight-base/2026-03-17/audit.json"
---
...
```bash
# Re-run evaluation
sh skills/agentic-harness/skill-quality-auditor/scripts/evaluate.sh documentation/astro-starlight/skills/starlight-base --json --store

# Check target score achieved
sh skills/agentic-harness/skill-quality-auditor/scripts/evaluate.sh documentation/astro-starlight/skills/starlight-base --json | jq ".total >= 126"
```
...
```bash
git checkout HEAD~1 -- skills/documentation/astro-starlight/skills/starlight-base/SKILL.md
```
