# Remediation Plan: documentation/markdown-authoring

---
plan_date: "2026-07-01"
skill_name: "documentation/markdown-authoring"
source_audit: ".context/audits/documentation/markdown-authoring/2026-07-01/audit.json"
---
...
**File**: `skills/documentation/markdown-authoring/SKILL.md`
...
```bash
git checkout HEAD~1 -- skills/documentation/markdown-authoring/SKILL.md
```
