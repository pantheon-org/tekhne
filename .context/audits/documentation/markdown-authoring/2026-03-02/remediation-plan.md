...
source_audit: ".context/audits/markdown-authoring/2026-03-02/audit.json"
---
...
```bash
# Re-run evaluation
sh skills/skill-quality-auditor/scripts/evaluate.sh markdown-authoring --json --store

# Check target score achieved
sh skills/skill-quality-auditor/scripts/evaluate.sh markdown-authoring --json | jq '.total >= 108'
```
