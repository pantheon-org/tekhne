...
skill_location: skills/markdown-authoring/SKILL.md
---
...
- skills/markdown-authoring/SKILL.md:1
...
- skills/markdown-authoring/SKILL.md:1
- **Evidence**: File size is 120 lines; references count is 16.
...
- skills/markdown-authoring/SKILL.md for generic tutorial language vs project-specific guidance.
...
**Re-check**: sh skills/skill-quality-auditor/scripts/evaluate.sh markdown-authoring --json
...
skills/skill-quality-auditor/scripts/validate-review-format.sh .context/audits/markdown-authoring-audit-2026-02-23.md
```
