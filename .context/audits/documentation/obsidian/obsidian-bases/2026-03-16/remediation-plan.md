...
**File**: `skills/documentation/obsidian/obsidian-bases/SKILL.md`
...
sh skills/agentic-harness/skill-quality-auditor/scripts/evaluate.sh documentation/obsidian/obsidian-bases --json | jq ".total >= 112"
```
