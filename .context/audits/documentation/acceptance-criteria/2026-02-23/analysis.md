...
- skills/acceptance-criteria/SKILL.md:1
- **Evidence**: File size is 121 lines; references count is 5.
...
skills/skill-quality-auditor/scripts/validate-review-format.sh .context/audits/acceptance-criteria-audit-2026-02-23.md
```
