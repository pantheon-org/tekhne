...
source_audit: ".context/audits/journal-entry-creator/2026-03-02/audit.json"
---
...
sh skills/skill-quality-auditor/scripts/evaluate.sh journal-entry-creator --json | jq '.total >= 102'
```
