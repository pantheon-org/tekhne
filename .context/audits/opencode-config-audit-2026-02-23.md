...
skill_location: skills/opencode-config/SKILL.md
---
...
| --- | ---: | ---: | --- |
| D1: Knowledge Delta | 19 | 20 | Depth of non-obvious guidance |
...
| D6: Freedom Calibration | 14 | 15 | Constraint/flexibility balance |
| D7: Pattern Recognition | 10 | 10 | Trigger/intent discoverability |
| D8: Practical Usability | 11 | 15 | Actionable examples/commands |

## Critical Issues

### 1. Score-to-grade risk

- skills/opencode-config/SKILL.md:1
- **Evidence**: Score is 112/120 (grade A).
- **Impact**: Lower score reduces reliability and clarity for execution.

### 2. Maintainability pressure

- skills/opencode-config/SKILL.md:1
- **Evidence**: File size is 112 lines; references count is 3.
...
**Assessment**: 19/20 (signal: strong, priority: low)

**Inspect**:

- skills/opencode-config/SKILL.md for generic tutorial language vs project-specific guidance.
...
**Re-check**: sh skills/skill-quality-auditor/scripts/evaluate.sh opencode-config --json
...
skills/skill-quality-auditor/scripts/validate-review-format.sh .context/audits/opencode-config-audit-2026-02-23.md
```
