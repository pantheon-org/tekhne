...
- skills/opencode-config/SKILL.md:1
- **Evidence**: File size is 280 lines; references count is 1.
...
skills/skill-quality-auditor/scripts/validate-review-format.sh .context/audits/opencode-config-audit-2026-02-21.md
```
