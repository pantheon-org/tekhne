...
skill_location: skills/cdk-nag/SKILL.md
---
...
- skills/cdk-nag/SKILL.md:1
- **Evidence**: Score is 103/120 (grade B+).
- **Impact**: Lower score reduces reliability and clarity for execution.

### 2. Maintainability pressure

- skills/cdk-nag/SKILL.md:1
- **Evidence**: File size is 123 lines; references count is 6.
...
- skills/cdk-nag/SKILL.md for generic tutorial language vs project-specific guidance.
...
**Re-check**: sh skills/skill-quality-auditor/scripts/evaluate.sh cdk-nag --json
...
skills/skill-quality-auditor/scripts/validate-review-format.sh .context/audits/cdk-nag-audit-2026-02-23.md
```
