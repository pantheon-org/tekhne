...
skill_name: "cdk-nag"
source_audit: ".context/audits/cdk-nag/2026-03-02/audit.json"
---
...
```bash
# Re-run evaluation
sh skills/skill-quality-auditor/scripts/evaluate.sh cdk-nag --json --store

# Check target score achieved
sh skills/skill-quality-auditor/scripts/evaluate.sh cdk-nag --json | jq '.total >= 108'
```
