# Remediation Plan: dockerfile-validator

---
plan_date: "2026-03-02"
skill_name: "dockerfile-validator"
source_audit: ".context/audits/dockerfile-validator/2026-03-02/audit.json"
---
...
**File**: `skills/dockerfile-validator/SKILL.md`
...
```bash
# Re-run evaluation
sh skills/skill-quality-auditor/scripts/evaluate.sh dockerfile-validator --json --store

# Check target score achieved
sh skills/skill-quality-auditor/scripts/evaluate.sh dockerfile-validator --json | jq '.total >= 108'
```
...
```bash
git checkout HEAD~1 -- skills/dockerfile-validator/SKILL.md
```
