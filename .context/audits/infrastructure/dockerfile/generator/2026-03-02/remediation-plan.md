# Remediation Plan: dockerfile-generator

---
plan_date: "2026-03-02"
skill_name: "dockerfile-generator"
source_audit: ".context/audits/dockerfile-generator/2026-03-02/audit.json"
---
...
**File**: `skills/dockerfile-generator/SKILL.md`
...
sh skills/skill-quality-auditor/scripts/evaluate.sh dockerfile-generator --json | jq '.total >= 108'
```
...
```bash
git checkout HEAD~1 -- skills/dockerfile-generator/SKILL.md
```
