# Remediation Plan: terraform-generator

---
plan_date: "2026-03-02"
skill_name: "terraform-generator"
source_audit: ".context/audits/terraform-generator/2026-03-02/audit.json"
---
...
**File**: `skills/terraform-generator/SKILL.md`
...
```bash
# Re-run evaluation
sh skills/skill-quality-auditor/scripts/evaluate.sh terraform-generator --json --store

# Check target score achieved
sh skills/skill-quality-auditor/scripts/evaluate.sh terraform-generator --json | jq '.total >= 108'
```
...
```bash
git checkout HEAD~1 -- skills/terraform-generator/SKILL.md
```
