# Remediation Plan: ansible-validator

---
plan_date: "2026-03-02"
skill_name: "ansible-validator"
source_audit: ".context/audits/ansible-validator/2026-03-02/audit.json"
---
...
**File**: `skills/ansible-validator/SKILL.md`
...
```bash
# Re-run evaluation
sh skills/skill-quality-auditor/scripts/evaluate.sh ansible-validator --json --store

# Check target score achieved
sh skills/skill-quality-auditor/scripts/evaluate.sh ansible-validator --json | jq '.total >= 108'
```
...
```bash
git checkout HEAD~1 -- skills/ansible-validator/SKILL.md
```
