# Remediation Plan: ansible-generator

---
plan_date: "2026-03-02"
skill_name: "ansible-generator"
source_audit: ".context/audits/ansible-generator/2026-03-02/audit.json"
---
...
**File**: `skills/ansible-generator/SKILL.md`
...
sh skills/skill-quality-auditor/scripts/evaluate.sh ansible-generator --json | jq '.total >= 102'
```
...
```bash
git checkout HEAD~1 -- skills/ansible-generator/SKILL.md
```
