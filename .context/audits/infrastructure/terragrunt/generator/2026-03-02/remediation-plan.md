# Remediation Plan: terragrunt-generator

---
plan_date: "2026-03-02"
skill_name: "terragrunt-generator"
source_audit: ".context/audits/terragrunt-generator/2026-03-02/audit.json"
---
...
**File**: `skills/terragrunt-generator/SKILL.md`
...
```bash
# Re-run evaluation
sh skills/skill-quality-auditor/scripts/evaluate.sh terragrunt-generator --json --store

# Check target score achieved
sh skills/skill-quality-auditor/scripts/evaluate.sh terragrunt-generator --json | jq '.total >= 108'
```
...
```bash
git checkout HEAD~1 -- skills/terragrunt-generator/SKILL.md
```
