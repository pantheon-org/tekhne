# Remediation Plan: infrastructure/k8s/debug

---
plan_date: "2026-03-06"
skill_name: "infrastructure/k8s/debug"
source_audit: ".context/audits/infrastructure/k8s/debug/2026-03-06/audit.json"
---
...
**File**: `skills/infrastructure/k8s/debug/SKILL.md`
...
```bash
# Re-run evaluation
sh skills/agentic-harness/skill-quality-auditor/scripts/evaluate.sh infrastructure/k8s/debug --json --store

# Check target score achieved
sh skills/agentic-harness/skill-quality-auditor/scripts/evaluate.sh infrastructure/k8s/debug --json | jq ".total >= 119"
```
...
```bash
git checkout HEAD~1 -- skills/infrastructure/k8s/debug/SKILL.md
```
