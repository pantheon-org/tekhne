...
skill_location: skills/create-context-file/SKILL.md
---
...
| D5: Progressive Disclosure | 12 | 15 | SKILL-to-references balance |
...
- skills/create-context-file/SKILL.md:1
...
- skills/create-context-file/SKILL.md:1
- **Evidence**: File size is 59 lines; references count is 0.
...
- skills/create-context-file/SKILL.md for generic tutorial language vs project-specific guidance.
...
**Re-check**: sh skills/skill-quality-auditor/scripts/evaluate.sh create-context-file --json
...
skills/skill-quality-auditor/scripts/validate-review-format.sh .context/audits/create-context-file-audit-2026-02-21.md
```
