...
skill_location: skills/cfn-behavior-validator/SKILL.md
---
...
| D5: Progressive Disclosure | 15 | 15 | SKILL-to-references balance |
...
- skills/cfn-behavior-validator/SKILL.md:1
...
- skills/cfn-behavior-validator/SKILL.md:1
- **Evidence**: File size is 79 lines; references count is 2.
...
- skills/cfn-behavior-validator/SKILL.md for generic tutorial language vs project-specific guidance.
...
**Re-check**: sh skills/skill-quality-auditor/scripts/evaluate.sh cfn-behavior-validator --json
...
skills/skill-quality-auditor/scripts/validate-review-format.sh .context/audits/cfn-behavior-validator-audit-2026-02-23.md
```
