...
skill_location: skills/test-driven-development/SKILL.md
---
...
| D3: Anti-Pattern Quality | 15 | 15 | Specificity and enforceability |
...
| D8: Practical Usability | 13 | 15 | Actionable examples/commands |
...
- skills/test-driven-development/SKILL.md:1
- **Evidence**: File size is 127 lines; references count is 42.
...
- skills/test-driven-development/SKILL.md for generic tutorial language vs project-specific guidance.
...
**Re-check**: sh skills/skill-quality-auditor/scripts/evaluate.sh test-driven-development --json
...
skills/skill-quality-auditor/scripts/validate-review-format.sh .context/audits/test-driven-development-audit-2026-02-23.md
```
