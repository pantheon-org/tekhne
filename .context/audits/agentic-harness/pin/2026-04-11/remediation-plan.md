...
skill_name: "agentic-harness/pin"
source_audit: ".context/audits/agentic-harness/pin/2026-04-11/audit.json"
---
...
```bash
# Re-run evaluation
./scripts/evaluate.sh agentic-harness/pin --json --store

# Check target score achieved
./scripts/evaluate.sh agentic-harness/pin --json | jq ".total >= 126"
```
...
```bash
git checkout HEAD~1 -- skills/agentic-harness/pin/SKILL.md
```
