...
skill_name: "agentic-harness/load-context"
source_audit: ".context/audits/agentic-harness/load-context/2026-04-11/audit.json"
---
...
**File**: `skills/agentic-harness/load-context/SKILL.md`
...
```bash
# Re-run evaluation
./scripts/evaluate.sh agentic-harness/load-context --json --store

# Check target score achieved
./scripts/evaluate.sh agentic-harness/load-context --json | jq ".total >= 112"
```
...
```bash
git checkout HEAD~1 -- skills/agentic-harness/load-context/SKILL.md
```
