...
- skills/skill-quality-auditor/SKILL.md:1
- **Evidence**: File size is 260 lines; references count is 14.
...
skills/skill-quality-auditor/scripts/validate-review-format.sh .context/audits/skill-quality-auditor-audit-2026-02-21.md
```
