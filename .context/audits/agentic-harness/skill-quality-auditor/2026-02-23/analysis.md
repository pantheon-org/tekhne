...
skill_location: skills/skill-quality-auditor/SKILL.md
---
...
- skills/skill-quality-auditor/SKILL.md:1
- **Evidence**: Score is 110/120 (grade A).
- **Impact**: Lower score reduces reliability and clarity for execution.

### 2. Maintainability pressure

- skills/skill-quality-auditor/SKILL.md:1
- **Evidence**: File size is 141 lines; references count is 17.
...
- skills/skill-quality-auditor/SKILL.md for generic tutorial language vs project-specific guidance.
...
**Re-check**: sh skills/skill-quality-auditor/scripts/evaluate.sh skill-quality-auditor --json
...
skills/skill-quality-auditor/scripts/validate-review-format.sh .context/audits/skill-quality-auditor-audit-2026-02-23.md
```
