...
skill_location: skills/agents-md/SKILL.md
---
...
- skills/agents-md/SKILL.md:1
- **Evidence**: File size is 99 lines; references count is 7.
...
- skills/agents-md/SKILL.md for generic tutorial language vs project-specific guidance.
...
**Re-check**: sh skills/skill-quality-auditor/scripts/evaluate.sh agents-md --json
...
skills/skill-quality-auditor/scripts/validate-review-format.sh .context/audits/agents-md-audit-2026-02-23.md
```
