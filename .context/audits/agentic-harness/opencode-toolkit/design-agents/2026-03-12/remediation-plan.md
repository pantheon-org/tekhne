# Remediation Plan: agentic-harness/opencode/agents

---
plan_date: "2026-03-12"
skill_name: "agentic-harness/opencode/agents"
source_audit: ".context/audits/agentic-harness/opencode/agents/2026-03-12/audit.json"
---
...
```bash
# Re-run evaluation
sh skills/agentic-harness/skill-quality-auditor/scripts/evaluate.sh agentic-harness/opencode/agents --json --store

# Check target score achieved
sh skills/agentic-harness/skill-quality-auditor/scripts/evaluate.sh agentic-harness/opencode/agents --json | jq ".total >= 126"
```
...
```bash
git checkout HEAD~1 -- skills/agentic-harness/opencode/agents/SKILL.md
```
