# Remediation Plan: agentic-harness/opencode/commands

---
plan_date: "2026-03-12"
skill_name: "agentic-harness/opencode/commands"
source_audit: ".context/audits/agentic-harness/opencode/commands/2026-03-12/audit.json"
---
...
```bash
# Re-run evaluation
sh skills/agentic-harness/skill-quality-auditor/scripts/evaluate.sh agentic-harness/opencode/commands --json --store

# Check target score achieved
sh skills/agentic-harness/skill-quality-auditor/scripts/evaluate.sh agentic-harness/opencode/commands --json | jq ".total >= 126"
```
...
```bash
git checkout HEAD~1 -- skills/agentic-harness/opencode/commands/SKILL.md
```
