...
skill_name: "agentic-harness/opencode-toolkit/design-commands"
source_audit: ".context/audits/agentic-harness/opencode-toolkit/design-commands/2026-03-14/audit.json"
---
...
```bash
# Re-run evaluation
sh skills/agentic-harness/skill-quality-auditor/scripts/evaluate.sh agentic-harness/opencode-toolkit/design-commands --json --store

# Check target score achieved
sh skills/agentic-harness/skill-quality-auditor/scripts/evaluate.sh agentic-harness/opencode-toolkit/design-commands --json | jq ".total >= 126"
```
...
```bash
git checkout HEAD~1 -- skills/agentic-harness/opencode-toolkit/design-commands/SKILL.md
```
