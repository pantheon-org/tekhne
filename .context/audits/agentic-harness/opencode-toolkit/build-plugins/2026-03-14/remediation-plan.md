# Remediation Plan: agentic-harness/opencode-toolkit/build-plugins

---
plan_date: "2026-03-14"
skill_name: "agentic-harness/opencode-toolkit/build-plugins"
source_audit: ".context/audits/agentic-harness/opencode-toolkit/build-plugins/2026-03-14/audit.json"
---
...
|-------|-----------|----------|--------|
| Missing mindset/procedures | D2 (9/15) | High | Agents lack decision frameworks |
...
```bash
# Re-run evaluation
sh skills/agentic-harness/skill-quality-auditor/scripts/evaluate.sh agentic-harness/opencode-toolkit/build-plugins --json --store

# Check target score achieved
sh skills/agentic-harness/skill-quality-auditor/scripts/evaluate.sh agentic-harness/opencode-toolkit/build-plugins --json | jq ".total >= 126"
```
...
```bash
git checkout HEAD~1 -- skills/agentic-harness/opencode-toolkit/build-plugins/SKILL.md
```
