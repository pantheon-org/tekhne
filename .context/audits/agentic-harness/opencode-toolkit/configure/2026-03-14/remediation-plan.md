...
skill_name: "agentic-harness/opencode-toolkit/configure"
source_audit: ".context/audits/agentic-harness/opencode-toolkit/configure/2026-03-14/audit.json"
---
...
**File**: `skills/agentic-harness/opencode-toolkit/configure/SKILL.md`
...
```bash
# Re-run evaluation
sh skills/agentic-harness/skill-quality-auditor/scripts/evaluate.sh agentic-harness/opencode-toolkit/configure --json --store

# Check target score achieved
sh skills/agentic-harness/skill-quality-auditor/scripts/evaluate.sh agentic-harness/opencode-toolkit/configure --json | jq ".total >= 126"
```
...
```bash
git checkout HEAD~1 -- skills/agentic-harness/opencode-toolkit/configure/SKILL.md
```
