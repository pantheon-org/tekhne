...
skill_name: "agentic-harness/save-context"
source_audit: ".context/audits/agentic-harness/save-context/2026-04-11/audit.json"
---
...
**File**: `skills/agentic-harness/save-context/SKILL.md`
...
```bash
# Re-run evaluation
./scripts/evaluate.sh agentic-harness/save-context --json --store

# Check target score achieved
./scripts/evaluate.sh agentic-harness/save-context --json | jq ".total >= 112"
```
...
```bash
git checkout HEAD~1 -- skills/agentic-harness/save-context/SKILL.md
```
