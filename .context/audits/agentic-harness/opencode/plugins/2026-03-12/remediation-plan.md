# Remediation Plan: agentic-harness/opencode/plugins

---
plan_date: "2026-03-12"
skill_name: "agentic-harness/opencode/plugins"
source_audit: ".context/audits/agentic-harness/opencode/plugins/2026-03-12/audit.json"
---
...
```bash
# Re-run evaluation
sh skills/agentic-harness/skill-quality-auditor/scripts/evaluate.sh agentic-harness/opencode/plugins --json --store

# Check target score achieved
sh skills/agentic-harness/skill-quality-auditor/scripts/evaluate.sh agentic-harness/opencode/plugins --json | jq ".total >= 126"
```
...
```bash
git checkout HEAD~1 -- skills/agentic-harness/opencode/plugins/SKILL.md
```
