# Remediation Plan: agentic-harness/opencode/sdk-development

---
plan_date: "2026-03-12"
skill_name: "agentic-harness/opencode/sdk-development"
source_audit: ".context/audits/agentic-harness/opencode/sdk-development/2026-03-12/audit.json"
---
...
```bash
# Re-run evaluation
sh skills/agentic-harness/skill-quality-auditor/scripts/evaluate.sh agentic-harness/opencode/sdk-development --json --store

# Check target score achieved
sh skills/agentic-harness/skill-quality-auditor/scripts/evaluate.sh agentic-harness/opencode/sdk-development --json | jq ".total >= 126"
```
...
```bash
git checkout HEAD~1 -- skills/agentic-harness/opencode/sdk-development/SKILL.md
```
