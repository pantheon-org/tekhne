# Remediation Plan: agentic-harness/opencode/config

---
plan_date: "2026-03-12"
skill_name: "agentic-harness/opencode/config"
source_audit: ".context/audits/agentic-harness/opencode/config/2026-03-12/audit.json"
---
...
**File**: `skills/agentic-harness/opencode/config/SKILL.md`
...
```bash
# Re-run evaluation
sh skills/agentic-harness/skill-quality-auditor/scripts/evaluate.sh agentic-harness/opencode/config --json --store

# Check target score achieved
sh skills/agentic-harness/skill-quality-auditor/scripts/evaluate.sh agentic-harness/opencode/config --json | jq ".total >= 126"
```
...
```bash
git checkout HEAD~1 -- skills/agentic-harness/opencode/config/SKILL.md
```
