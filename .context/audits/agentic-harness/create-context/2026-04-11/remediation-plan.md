# Remediation Plan: agentic-harness/create-context

---
plan_date: "2026-04-11"
skill_name: "agentic-harness/create-context"
source_audit: ".context/audits/agentic-harness/create-context/2026-04-11/audit.json"
---
...
**File**: `skills/agentic-harness/create-context/SKILL.md`
...
```bash
# Re-run evaluation
./scripts/evaluate.sh agentic-harness/create-context --json --store

# Check target score achieved
./scripts/evaluate.sh agentic-harness/create-context --json | jq ".total >= 112"
```
...
```bash
git checkout HEAD~1 -- skills/agentic-harness/create-context/SKILL.md
```
