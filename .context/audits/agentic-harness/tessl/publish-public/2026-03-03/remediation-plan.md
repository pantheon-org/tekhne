...
source_audit: ".context/audits/agentic-harness/tessl-publish-public/2026-03-03/audit.json"
---
...
**File**: `skills/agentic-harness/tessl-publish-public/SKILL.md`
...
```bash
# Re-run evaluation
sh skills/skill-quality-auditor/scripts/evaluate.sh agentic-harness/tessl-publish-public --json --store

# Check target score achieved
sh skills/skill-quality-auditor/scripts/evaluate.sh agentic-harness/tessl-publish-public --json | jq '.total >= 102'
```
