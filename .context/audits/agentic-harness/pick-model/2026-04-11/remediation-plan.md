...
skill_name: "agentic-harness/pick-model"
source_audit: ".context/audits/agentic-harness/pick-model/2026-04-11/audit.json"
---
...
**File**: `skills/agentic-harness/pick-model/SKILL.md`
...
```bash
# Re-run evaluation
./scripts/evaluate.sh agentic-harness/pick-model --json --store

# Check target score achieved
./scripts/evaluate.sh agentic-harness/pick-model --json | jq ".total >= 112"
```
...
```bash
git checkout HEAD~1 -- skills/agentic-harness/pick-model/SKILL.md
```
