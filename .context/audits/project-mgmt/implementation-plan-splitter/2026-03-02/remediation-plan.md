...
source_audit: ".context/audits/implementation-plan-splitter/2026-03-02/audit.json"
---
...
```bash
# Re-run evaluation
sh skills/skill-quality-auditor/scripts/evaluate.sh implementation-plan-splitter --json --store

# Check target score achieved
sh skills/skill-quality-auditor/scripts/evaluate.sh implementation-plan-splitter --json | jq '.total >= 108'
```
...
```bash
git checkout HEAD~1 -- skills/implementation-plan-splitter/SKILL.md
```
