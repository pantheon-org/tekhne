...
source_audit: ".context/audits/project-mgmt/implementation-planner/2026-03-10/audit.json"
---
...
**File**: `skills/project-mgmt/implementation-planner/SKILL.md`
...
sh skills/agentic-harness/skill-quality-auditor/scripts/evaluate.sh project-mgmt/implementation-planner --json | jq ".total >= 119"
```
