# Skill Quality Analysis: project-mgmt/planning-toolkit/wave-execution-planner
...
|-----------|-------|-----|------------|--------|
| D1: Knowledge Delta | 20 | 20 | 100% | ✓ Good |
...
- **Skill Path**: skills/project-mgmt/planning-toolkit/wave-execution-planner/SKILL.md
- **Total Lines**: 135
- **Has References**: Yes
