...
source_audit: ".context/audits/create-context-file/2026-03-02/audit.json"
---
...
sh skills/skill-quality-auditor/scripts/evaluate.sh create-context-file --json | jq '.total >= 102'
```
