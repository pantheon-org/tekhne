...
skill_location: skills/moscow-prioritization/SKILL.md
---
...
- skills/moscow-prioritization/SKILL.md:1
...
- skills/moscow-prioritization/SKILL.md:1
- **Evidence**: File size is 118 lines; references count is 3.
...
- skills/moscow-prioritization/SKILL.md for generic tutorial language vs project-specific guidance.
...
**Re-check**: sh skills/skill-quality-auditor/scripts/evaluate.sh moscow-prioritization --json
...
skills/skill-quality-auditor/scripts/validate-review-format.sh .context/audits/moscow-prioritization-audit-2026-02-23.md
```
