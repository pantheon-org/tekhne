# Remediation Plan: azure-pipelines-validator

---
plan_date: "2026-03-02"
skill_name: "azure-pipelines-validator"
source_audit: ".context/audits/azure-pipelines-validator/2026-03-02/audit.json"
---
...
**Verdict**: Targeted improvements needed to reach grade B+ (+10 points).
...
**File**: `skills/azure-pipelines-validator/SKILL.md`
...
```bash
# Re-run evaluation
sh skills/skill-quality-auditor/scripts/evaluate.sh azure-pipelines-validator --json --store

# Check target score achieved
sh skills/skill-quality-auditor/scripts/evaluate.sh azure-pipelines-validator --json | jq '.total >= 102'
```
...
```bash
git checkout HEAD~1 -- skills/azure-pipelines-validator/SKILL.md
```
