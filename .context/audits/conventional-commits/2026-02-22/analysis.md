...
skill_location: skills/conventional-commits/SKILL.md
---
...
| D7: Pattern Recognition | 8 | 10 | Trigger/intent discoverability |
...
- skills/conventional-commits/SKILL.md:1
...
- skills/conventional-commits/SKILL.md:1
- **Evidence**: File size is 636 lines; references count is 0.
...
- skills/conventional-commits/SKILL.md for generic tutorial language vs project-specific guidance.
...
**Re-check**: sh skills/skill-quality-auditor/scripts/evaluate.sh conventional-commits --json
...
**Assessment**: 8/10 (signal: strong, priority: low)
...
skills/skill-quality-auditor/scripts/validate-review-format.sh .context/audits/conventional-commits-audit-2026-02-22.md
```
