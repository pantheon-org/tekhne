...
source_audit: ".context/audits/cfn-behavior-validator/2026-03-02/audit.json"
---
...
```bash
# Re-run evaluation
sh skills/skill-quality-auditor/scripts/evaluate.sh cfn-behavior-validator --json --store

# Check target score achieved
sh skills/skill-quality-auditor/scripts/evaluate.sh cfn-behavior-validator --json | jq '.total >= 108'
```
...
```bash
git checkout HEAD~1 -- skills/cfn-behavior-validator/SKILL.md
```
