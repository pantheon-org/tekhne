...
source_audit: ".context/audits/bun-development/2026-03-02/audit.json"
---
...
```bash
# Re-run evaluation
sh skills/skill-quality-auditor/scripts/evaluate.sh bun-development --json --store

# Check target score achieved
sh skills/skill-quality-auditor/scripts/evaluate.sh bun-development --json | jq '.total >= 108'
```
