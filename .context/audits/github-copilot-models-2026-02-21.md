...
**Skill Location**: `skills/github-copilot-models/SKILL.md`
...
```bash
bun run skills/skill-quality-auditor/scripts/evaluate.ts github-copilot-models
bunx markdownlint-cli2 "skills/github-copilot-models/SKILL.md"
```
...
`github-copilot-models` scores **89/120 (C)**.
