...
skill_location: skills/nx-workspace-patterns/SKILL.md
---
...
| --- | ---: | ---: | --- |
| D1: Knowledge Delta | 16 | 20 | Depth of non-obvious guidance |
| D2: Mindset + Procedures | 10 | 15 | Procedural clarity and sequencing |
| D3: Anti-Pattern Quality | 8 | 15 | Specificity and enforceability |
| D4: Specification Compliance | 13 | 15 | Metadata/spec alignment |
| D5: Progressive Disclosure | 7 | 15 | SKILL-to-references balance |
| D6: Freedom Calibration | 10 | 15 | Constraint/flexibility balance |
| D7: Pattern Recognition | 9 | 10 | Trigger/intent discoverability |
| D8: Practical Usability | 15 | 15 | Actionable examples/commands |

## Critical Issues

### 1. Score-to-grade risk

- skills/nx-workspace-patterns/SKILL.md:1
- **Evidence**: Score is 88/120 (grade C).
- **Impact**: Lower score reduces reliability and clarity for execution.

### 2. Maintainability pressure

- skills/nx-workspace-patterns/SKILL.md:1
- **Evidence**: File size is 457 lines; references count is 0.
...
**Assessment**: 16/20 (signal: strong, priority: low)

**Inspect**:

- skills/nx-workspace-patterns/SKILL.md for generic tutorial language vs project-specific guidance.
...
**Re-check**: sh skills/skill-quality-auditor/scripts/evaluate.sh nx-workspace-patterns --json
...
**Assessment**: 8/15 (signal: weak, priority: high)
...
**Assessment**: 7/15 (signal: weak, priority: high)
...
**Assessment**: 9/10 (signal: strong, priority: low)
...
**Assessment**: 15/15 (signal: strong, priority: low)
...
skills/skill-quality-auditor/scripts/validate-review-format.sh .context/audits/nx-workspace-patterns-audit-2026-02-21.md
```
