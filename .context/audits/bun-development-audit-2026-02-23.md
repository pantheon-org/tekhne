...
skill_location: skills/bun-development/SKILL.md
---
...
- skills/bun-development/SKILL.md:1
- **Evidence**: Score is 105/120 (grade B+).
- **Impact**: Lower score reduces reliability and clarity for execution.

### 2. Maintainability pressure

- skills/bun-development/SKILL.md:1
- **Evidence**: File size is 176 lines; references count is 13.
...
- skills/bun-development/SKILL.md for generic tutorial language vs project-specific guidance.
...
**Re-check**: sh skills/skill-quality-auditor/scripts/evaluate.sh bun-development --json
...
skills/skill-quality-auditor/scripts/validate-review-format.sh .context/audits/bun-development-audit-2026-02-23.md
```
