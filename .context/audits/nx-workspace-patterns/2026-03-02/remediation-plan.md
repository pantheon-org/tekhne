...
source_audit: ".context/audits/nx-workspace-patterns/2026-03-02/audit.json"
---
...
```bash
# Re-run evaluation
sh skills/skill-quality-auditor/scripts/evaluate.sh nx-workspace-patterns --json --store

# Check target score achieved
sh skills/skill-quality-auditor/scripts/evaluate.sh nx-workspace-patterns --json | jq '.total >= 108'
```
