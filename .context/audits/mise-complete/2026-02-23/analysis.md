...
skill_location: skills/mise-complete/SKILL.md
---
...
- skills/mise-complete/SKILL.md:1
...
- skills/mise-complete/SKILL.md:1
- **Evidence**: File size is 135 lines; references count is 16.
...
- skills/mise-complete/SKILL.md for generic tutorial language vs project-specific guidance.
...
**Re-check**: sh skills/skill-quality-auditor/scripts/evaluate.sh mise-complete --json
...
skills/skill-quality-auditor/scripts/validate-review-format.sh .context/audits/mise-complete-audit-2026-02-23.md
```
