...
skill_location: skills/github-copilot-models/SKILL.md
---

# Skill Evaluation Report: github-copilot-models
...
- skills/github-copilot-models/SKILL.md:1
...
- skills/github-copilot-models/SKILL.md:1
- **Evidence**: File size is 281 lines; references count is 0.
...
- skills/github-copilot-models/SKILL.md for generic tutorial language vs project-specific guidance.
...
**Re-check**: sh skills/skill-quality-auditor/scripts/evaluate.sh github-copilot-models --json
...
skills/skill-quality-auditor/scripts/validate-review-format.sh .context/audits/github-copilot-models-audit-2026-02-22.md
```

## Files Inventory

```text
skills/github-copilot-models/
├── SKILL.md
├── AGENTS.md (optional)
├── references/ (optional)
├── templates/ (optional)
