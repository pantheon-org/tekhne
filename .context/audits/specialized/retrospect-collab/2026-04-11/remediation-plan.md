...
skill_name: "specialized/retrospect-collab"
source_audit: ".context/audits/specialized/retrospect-collab/2026-04-11/audit.json"
---
...
```bash
# Re-run evaluation
./scripts/evaluate.sh specialized/retrospect-collab --json --store

# Check target score achieved
./scripts/evaluate.sh specialized/retrospect-collab --json | jq ".total >= 126"
```
...
```bash
git checkout HEAD~1 -- skills/specialized/retrospect-collab/SKILL.md
```
