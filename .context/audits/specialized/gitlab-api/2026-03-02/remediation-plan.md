# Remediation Plan: gitlab-api

---
plan_date: "2026-03-02"
skill_name: "gitlab-api"
source_audit: ".context/audits/gitlab-api/2026-03-02/audit.json"
---
...
**File**: `skills/gitlab-api/SKILL.md`
...
```bash
# Re-run evaluation
sh skills/skill-quality-auditor/scripts/evaluate.sh gitlab-api --json --store

# Check target score achieved
sh skills/skill-quality-auditor/scripts/evaluate.sh gitlab-api --json | jq '.total >= 102'
```
...
```bash
git checkout HEAD~1 -- skills/gitlab-api/SKILL.md
```
