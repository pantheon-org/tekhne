# Remediation Plan: specialized/retrospect-domain

---
plan_date: "2026-04-11"
skill_name: "specialized/retrospect-domain"
source_audit: ".context/audits/specialized/retrospect-domain/2026-04-11/audit.json"
---
...
```bash
# Re-run evaluation
./scripts/evaluate.sh specialized/retrospect-domain --json --store

# Check target score achieved
./scripts/evaluate.sh specialized/retrospect-domain --json | jq ".total >= 126"
```
...
```bash
git checkout HEAD~1 -- skills/specialized/retrospect-domain/SKILL.md
```
