# Remediation Plan: specialized/chezmoi/managing-chezmoi-packages

---
plan_date: "2026-04-24"
skill_name: "specialized/chezmoi/managing-chezmoi-packages"
source_audit: ".context/audits/specialized/chezmoi/managing-chezmoi-packages/2026-04-24/audit.json"
---
...
```bash
# Re-run evaluation
./scripts/evaluate.sh specialized/chezmoi/managing-chezmoi-packages --json --store

# Check target score achieved
./scripts/evaluate.sh specialized/chezmoi/managing-chezmoi-packages --json | jq ".total >= 126"
```
...
```bash
git checkout HEAD~1 -- skills/specialized/chezmoi/managing-chezmoi-packages/SKILL.md
```
