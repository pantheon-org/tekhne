...
source_audit: ".context/audits/software-design-principles/2026-03-02/audit.json"
---
...
```bash
# Re-run evaluation
sh skills/skill-quality-auditor/scripts/evaluate.sh software-design-principles --json --store

# Check target score achieved
sh skills/skill-quality-auditor/scripts/evaluate.sh software-design-principles --json | jq '.total >= 108'
```
...
```bash
git checkout HEAD~1 -- skills/software-design-principles/SKILL.md
```
