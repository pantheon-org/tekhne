...
skill_location: skills/commanderjs/SKILL.md
---
...
- skills/commanderjs/SKILL.md:1
- **Evidence**: File size is 201 lines; references count is 6.
...
- skills/commanderjs/SKILL.md for generic tutorial language vs project-specific guidance.
...
**Re-check**: sh skills/skill-quality-auditor/scripts/evaluate.sh commanderjs --json
...
skills/skill-quality-auditor/scripts/validate-review-format.sh .context/audits/commanderjs-audit-2026-02-22.md
```
