...
skill_location: skills/nx-executors/SKILL.md
---
...
| --- | ---: | ---: | --- |
| D1: Knowledge Delta | 20 | 20 | Depth of non-obvious guidance |
| D2: Mindset + Procedures | 15 | 15 | Procedural clarity and sequencing |
...
| D6: Freedom Calibration | 15 | 15 | Constraint/flexibility balance |
...
- skills/nx-executors/SKILL.md:1
- **Evidence**: Score is 116/120 (grade A+).
- **Impact**: Lower score reduces reliability and clarity for execution.

### 2. Maintainability pressure

- skills/nx-executors/SKILL.md:1
- **Evidence**: File size is 129 lines; references count is 2.
...
**Assessment**: 20/20 (signal: strong, priority: low)

**Inspect**:

- skills/nx-executors/SKILL.md for generic tutorial language vs project-specific guidance.
...
**Re-check**: sh skills/skill-quality-auditor/scripts/evaluate.sh nx-executors --json
...
skills/skill-quality-auditor/scripts/validate-review-format.sh .context/audits/nx-executors-audit-2026-02-23.md
```
