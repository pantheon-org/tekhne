...
- skills/nx-bun-integration/SKILL.md:1
- **Evidence**: File size is 144 lines; references count is 4.
...
skills/skill-quality-auditor/scripts/validate-review-format.sh .context/audits/nx-bun-integration-audit-2026-02-23.md
```
