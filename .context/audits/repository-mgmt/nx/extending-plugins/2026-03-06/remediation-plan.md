# Remediation Plan: repository-mgmt/nx/extending-plugins

---
plan_date: "2026-03-06"
skill_name: "repository-mgmt/nx/extending-plugins"
source_audit: ".context/audits/repository-mgmt/nx/extending-plugins/2026-03-06/audit.json"
---
...
**File**: `skills/repository-mgmt/nx/extending-plugins/SKILL.md`
...
```bash
# Re-run evaluation
sh skills/agentic-harness/skill-quality-auditor/scripts/evaluate.sh repository-mgmt/nx/extending-plugins --json --store

# Check target score achieved
sh skills/agentic-harness/skill-quality-auditor/scripts/evaluate.sh repository-mgmt/nx/extending-plugins --json | jq ".total >= 119"
```
...
```bash
git checkout HEAD~1 -- skills/repository-mgmt/nx/extending-plugins/SKILL.md
```
