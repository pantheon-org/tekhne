...
skill_location: skills/nx-bun-integration/SKILL.md
---
...
| --- | ---: | ---: | --- |
| D1: Knowledge Delta | 13 | 20 | Depth of non-obvious guidance |
| D2: Mindset + Procedures | 11 | 15 | Procedural clarity and sequencing |
...
| D7: Pattern Recognition | 10 | 10 | Trigger/intent discoverability |
...
- skills/nx-bun-integration/SKILL.md:1
- **Evidence**: Score is 87/120 (grade C).
- **Impact**: Lower score reduces reliability and clarity for execution.

### 2. Maintainability pressure

- skills/nx-bun-integration/SKILL.md:1
- **Evidence**: File size is 897 lines; references count is 0.
...
**Assessment**: 13/20 (signal: moderate, priority: medium)

**Inspect**:

- skills/nx-bun-integration/SKILL.md for generic tutorial language vs project-specific guidance.
...
**Re-check**: sh skills/skill-quality-auditor/scripts/evaluate.sh nx-bun-integration --json
...
**Assessment**: 10/10 (signal: strong, priority: low)
...
skills/skill-quality-auditor/scripts/validate-review-format.sh .context/audits/nx-bun-integration-audit-2026-02-21.md
```
