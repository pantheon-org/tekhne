...
skill_name: "repository-mgmt/nx/bun-integration"
source_audit: ".context/audits/repository-mgmt/nx/bun-integration/2026-03-06/audit.json"
---
...
**File**: `skills/repository-mgmt/nx/bun-integration/SKILL.md`
...
```bash
# Re-run evaluation
sh skills/agentic-harness/skill-quality-auditor/scripts/evaluate.sh repository-mgmt/nx/bun-integration --json --store

# Check target score achieved
sh skills/agentic-harness/skill-quality-auditor/scripts/evaluate.sh repository-mgmt/nx/bun-integration --json | jq ".total >= 119"
```
...
```bash
git checkout HEAD~1 -- skills/repository-mgmt/nx/bun-integration/SKILL.md
```
