...
skill_name: "repository-mgmt/nx/nx-plugin-authoring"
source_audit: ".context/audits/repository-mgmt/nx/nx-plugin-authoring/2026-03-06/audit.json"
---
...
**Verdict**: Targeted improvements needed to reach grade B+ (+16 points).
...
**File**: `skills/repository-mgmt/nx/nx-plugin-authoring/SKILL.md`
...
```bash
# Re-run evaluation
sh skills/agentic-harness/skill-quality-auditor/scripts/evaluate.sh repository-mgmt/nx/nx-plugin-authoring --json --store

# Check target score achieved
sh skills/agentic-harness/skill-quality-auditor/scripts/evaluate.sh repository-mgmt/nx/nx-plugin-authoring --json | jq ".total >= 119"
```
...
```bash
git checkout HEAD~1 -- skills/repository-mgmt/nx/nx-plugin-authoring/SKILL.md
```
