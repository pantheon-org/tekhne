...
skill_location: skills/nx-generators/SKILL.md
---
...
- skills/nx-generators/SKILL.md:1
- **Evidence**: Score is 96/120 (grade B).
- **Impact**: Lower score reduces reliability and clarity for execution.

### 2. Maintainability pressure

- skills/nx-generators/SKILL.md:1
- **Evidence**: File size is 288 lines; references count is 0.
...
- skills/nx-generators/SKILL.md for generic tutorial language vs project-specific guidance.
...
**Re-check**: sh skills/skill-quality-auditor/scripts/evaluate.sh nx-generators --json
...
skills/skill-quality-auditor/scripts/validate-review-format.sh .context/audits/nx-generators-audit-2026-02-22.md
```
