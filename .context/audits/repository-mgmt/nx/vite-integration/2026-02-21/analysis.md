...
| D2: Mindset + Procedures | 8 | 15 | Procedural clarity and sequencing |
...
- skills/nx-vite-integration/SKILL.md:1
- **Evidence**: Score is 76/120 (grade F).
- **Impact**: Lower score reduces reliability and clarity for execution.

### 2. Maintainability pressure

- skills/nx-vite-integration/SKILL.md:1
- **Evidence**: File size is 558 lines; references count is 0.
...
- skills/nx-vite-integration/SKILL.md for generic tutorial language vs project-specific guidance.
...
**Re-check**: sh skills/skill-quality-auditor/scripts/evaluate.sh nx-vite-integration --json
...
skills/skill-quality-auditor/scripts/validate-review-format.sh .context/audits/nx-vite-integration-audit-2026-02-21.md
```
