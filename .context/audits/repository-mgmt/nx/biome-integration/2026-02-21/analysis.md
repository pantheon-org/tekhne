...
- skills/nx-biome-integration/SKILL.md:1
- **Evidence**: File size is 383 lines; references count is 1.
...
skills/skill-quality-auditor/scripts/validate-review-format.sh .context/audits/nx-biome-integration-audit-2026-02-21.md
```
