...
skill_name: "repository-mgmt/nx/biome-integration"
source_audit: ".context/audits/repository-mgmt/nx/biome-integration/2026-03-06/audit.json"
---
...
**File**: `skills/repository-mgmt/nx/biome-integration/SKILL.md`
...
```bash
# Re-run evaluation
sh skills/agentic-harness/skill-quality-auditor/scripts/evaluate.sh repository-mgmt/nx/biome-integration --json --store

# Check target score achieved
sh skills/agentic-harness/skill-quality-auditor/scripts/evaluate.sh repository-mgmt/nx/biome-integration --json | jq ".total >= 119"
```
...
```bash
git checkout HEAD~1 -- skills/repository-mgmt/nx/biome-integration/SKILL.md
```
