# Remediation Plan: repository-mgmt/nx/workspace-patterns

---
plan_date: "2026-03-06"
skill_name: "repository-mgmt/nx/workspace-patterns"
source_audit: ".context/audits/repository-mgmt/nx/workspace-patterns/2026-03-06/audit.json"
---
...
**File**: `skills/repository-mgmt/nx/workspace-patterns/SKILL.md`
...
```bash
# Re-run evaluation
sh skills/agentic-harness/skill-quality-auditor/scripts/evaluate.sh repository-mgmt/nx/workspace-patterns --json --store

# Check target score achieved
sh skills/agentic-harness/skill-quality-auditor/scripts/evaluate.sh repository-mgmt/nx/workspace-patterns --json | jq ".total >= 119"
```
...
```bash
git checkout HEAD~1 -- skills/repository-mgmt/nx/workspace-patterns/SKILL.md
```
