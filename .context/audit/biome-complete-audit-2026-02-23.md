...
skill_location: skills/biome-complete/SKILL.md
---
...
- skills/biome-complete/SKILL.md:1
...
- skills/biome-complete/SKILL.md:1
- **Evidence**: File size is 135 lines; references count is 4.
...
- skills/biome-complete/SKILL.md for generic tutorial language vs project-specific guidance.
...
**Re-check**: sh skills/skill-quality-auditor/scripts/evaluate.sh biome-complete --json
...
skills/skill-quality-auditor/scripts/validate-review-format.sh .context/audits/biome-complete-audit-2026-02-23.md
```
